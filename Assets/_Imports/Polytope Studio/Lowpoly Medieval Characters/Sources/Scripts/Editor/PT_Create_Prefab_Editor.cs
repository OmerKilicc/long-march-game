...
namespace Polytope
{
    ...
    public class PT_Create_Prefab_Editor : Editor
    {
        ...
        private void ShaderProperty_CSP(string name, string label)
        {
            ...
            {
                SerializedProperty power = serializedObject.FindProperty(name).FindPropertyRelative("enemyPower");
        ...
        private void GetDefaultProperty_CSP(string name)
        {
            ...
            if (IsMaterialProperty(shaderPower))
            {
                serializedObject.FindProperty(name).FindPropertyRelative("enemyPower").floatValue = dftmat.GetFloat(shaderPower);
            }
        }
